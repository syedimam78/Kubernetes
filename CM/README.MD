...
If you want to update the data file (data values) pods doesn't need to be restart. Update the data-file with any value and also update configmap as below
kubectl create configmap configmap-3 \
  --from-file=data-file \
